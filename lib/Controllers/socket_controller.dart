...
import 'package:pce/models/events.dart';
...
class SocketController {
  ...
  /// - `connected`: socket connection success callback method.
  ...
  void storeUserId(String userID) {
    ...
    final _socket = this._socket!;
    _socket.emit(
      enumToString(OUTEvent.store_user_id),
      userID,
    );
    log("storeUserId ${userID}");
  }
  ...
  ///
  void sendMessage(GetUserMessagesResponseData message) {
    _connectedAssetion();
    ...
    _socket
      ...
      ..emit(
        enumToString(OUTEvent.sendMessage),
        message,
      );
  ...
  String get _localhost {
    ...
    //Android local url
    return Constants.CHAT_BASE_URL;;
    // return '${_uri.scheme}:192.168.0.102:${_uri.port}';
  }
}
